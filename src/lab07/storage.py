...
def _weapon_to_dict(weapon: Weapon) -> Dict[str, Any]:
    data = {
        ...
        'tip': weapon._tip,
        'kolichestvo': weapon._Weapon__kolichestvo
    }
...
def _dict_to_weapon(data: Dict[str, Any]) -> Weapon:
    ...
    if weapon_type == 'Firearms':
        return Firearms(
            damage=data['damage'], rare=data['rare'], hardness=data['hardness'],
            effects=data['effects'], tip=data['tip'], imia=data['imia'],
            kolichestvo=data['kolichestvo'], caliber=data['caliber'],
        ...
        return Edged(
            damage=data['damage'], rare=data['rare'], hardness=data['hardness'],
            effects=data['effects'], tip=data['tip'], imia=data['imia'],
            kolichestvo=data['kolichestvo'], blade_length=data['blade_length'],
